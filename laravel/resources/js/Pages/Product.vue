                        ...
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-3">
                                <span class="text-sm text-gray-500"
                                    >{{ quoteStore.uniqueProductsCount }}/10
                                    products</span
                                >
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div class="flex flex-wrap items-center gap-4">
                                    <!-- Product Image -->
                                    <div
                                        class="h-16 w-16 flex-none overflow-hidden rounded-md"
                                    >
                                        <img
                                            :src="getProductPicture(item)"
                                            :alt="getProductTitle(item)"
                                            class="h-full w-full object-cover"
                                            @error="onProductPictureError"
                                        />
                                    </div>
                ...
                <div class="lg:col-span-3">
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <img
                                    class="h-auto w-full rounded-lg border border-primary-50 object-cover"
                                    :src="
                                        currentImage ||
                                        product.picture ||
                            ...
                            >
                                <div
                                    v-for="(
                                        image, index
                                    ) in product.pictures as iPicture[]"
                                    :key="index"
                                    @click="
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="rounded-lg border border-gray-200">
                                    <dl class="divide-y divide-gray-200">
                                        <div
                                            v-for="(
                                                attribute, index
                                            ) in formattedAttributes"
                                            :key="index"
                                            class="flex flex-col px-6 py-4 hover:bg-gray-50 sm:flex-row sm:items-center sm:justify-between"
                                        >
                                            <dt
                                                class="mb-1 text-sm font-medium text-gray-500 sm:mb-0"
                                            >
                                                {{ attribute.name }}
                                            </dt>
                                            <dd
                                                class="text-sm text-gray-900 sm:text-right"
                                            >
                                                {{ attribute.value }}
                                            </dd>
                                        </div>
                            ...
                            >
                                ...
                                <div class="flex gap-3">
                                    ...
                                    >
                                        <svg
                                            class="mr-2 inline h-5 w-5 text-gray-400"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6 rounded-lg bg-gray-50 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div
                                    class="h-16 w-16 flex-none overflow-hidden rounded-lg"
                                >
                                    <img
                        ...
                        <!-- Quote Summary -->
                        <div
                            v-if="quoteStore.uniqueProductsCount > 0"
                        ...
                        <!-- Additional Info -->
                        <div
                            class="mt-8 space-y-4 border-t border-gray-200 pt-6"
                        >
                            <div class="flex items-start gap-3">
                                <svg
                                    class="h-6 w-6 flex-none text-green-600"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
