// Components/Web/ProductCard.vue - ENHANCED DESIGN
...
<template>
    <div
        class="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
    ...
    >
        ...
        <!-- Image Container -->
        <div
            class="relative h-56 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 md:h-64"
        >
            <!-- Main Image -->
            <img
        ...
        <div class="flex flex-1 flex-col p-5">
            <!-- Title -->
            <h3
                class="mb-2 line-clamp-2 font-bold text-gray-900 transition-colors group-hover:text-primary-600"
            >
                {{ title }}
            </h3>
